...
function labelAtpx(val, x, y, z,id){
    ...
    em.setAttribute("style","z-index:"+z+";left:"+(x/10.79)+"vh;top:"+(y/11.06)+"vh; width:0px; height:0px; font-size:1.61vh; white-space: nowrap;margin-top: "+(2.1)+"vh; margin-left: "+(3.221)+"vh; position:fixed;");//font13px
    return em;
}
